...
<div class="col-sm-12">
    <a href="<?= base_url('dsn/PrintNilai/' . $jadwal['id_jadwal']) ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> Print Nilai</a>
</div>
<?php
  ...
  <?php echo form_open('dsn/SimpanNilai/' . $jadwal['id_jadwal']) ?>
    ...
    <button class="btn btn-info"><i class="fa fa-save"></i> Simpan dan Proses</button>
    <?php echo form_close() ?>
  </div>
</div>