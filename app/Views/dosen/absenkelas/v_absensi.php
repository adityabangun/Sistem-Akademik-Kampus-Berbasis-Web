...
<div class="col-sm-12">
    <a href="<?= base_url('dsn/print_absensi/' . $jadwal['id_jadwal']) ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> Print Absensi</a>
</div>
<div class="col-sm-12">
              <?php
...
<tr class="label-success">
  ...
  <tr class="label-success">
    ...
    <button class="btn btn-info"><i class="fa fa-save"></i> Simpan Absensi</button>
    <?php echo form_close() ?>
</div>
</div>