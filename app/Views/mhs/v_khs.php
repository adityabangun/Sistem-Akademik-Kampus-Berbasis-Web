...
<div class="col-sm-12">
    <a href="<?= base_url('mhs/print_khs') ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> Print KHS</a>
</div>
<div class="col-sm-12">
    <table class="table table-striped table-bordered table-responsive">
        ...
        foreach ($data_matkul as $key => $value) { 
          ...
          $grant_tot_bobot = $grant_tot_bobot + $tot_bobot;
          ?>
          <tr>
    ...
    <h4><b>IP : <?php if (empty($data_matkul)) {
        ...
        echo number_format($grant_tot_bobot / $sks, 2);
    } ?></b></h4>
</div>
</div>